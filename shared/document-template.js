...
function formalActionTable(title = "") {
  ...
  return `<table data-template-table="action" style="width: 100%; border-collapse: collapse; margin: 0 0 12pt"><tbody><tr><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">任务/交付物</th><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">负责人</th><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">完成期限</th><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">验收标准</th></tr><tr><td style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td><td style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td><td style="border: 1px solid #A6A6A6; padding: 6pt">【YYYY-MM-DD】</td><td style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td></tr></tbody></table>`;
}
...
export function buildFormalTemplateContent(template, options = {}) {
  ...
  const metadata = `<table data-template-table="metadata" style="width: 100%; border-collapse: collapse; margin: 0 0 14pt"><tbody><tr><th style="width: 18%; border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">文档主题</th><td style="border: 1px solid #A6A6A6; padding: 6pt">${title}</td><th style="width: 18%; border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">版本</th><td style="border: 1px solid #A6A6A6; padding: 6pt">V1.0</td></tr><tr><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">适用对象</th><td style="border: 1px solid #A6A6A6; padding: 6pt">${audience}</td><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">建议篇幅</th><td style="border: 1px solid #A6A6A6; padding: 6pt">${expectedPages}</td></tr><tr><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">编制人/部门</th><td style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td><th style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F2F2">编制日期</th><td style="border: 1px solid #A6A6A6; padding: 6pt">【YYYY-MM-DD】</td></tr></tbody></table>`;
