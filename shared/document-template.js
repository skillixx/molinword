...
// 中文注解：正式商务模板使用固定 A4 可用宽度和统一单元格留白，避免 Word/LibreOffice 自动列宽产生漂移。
const formalTableGeometry = `data-table-width-type="dxa" data-table-width-value="9360" data-table-grid-width="9360" data-table-layout="fixed" data-table-alignment="left" data-table-indent="120"`;
...
function formalActionTable(title = "") {
  ...
  return `<table data-template-table="action" ${formalTableGeometry} ${formalTableBorders} style="width: 100%; table-layout: fixed; border-collapse: collapse; margin: 0 0 12pt"><thead><tr data-row-repeat-header="true" data-row-cant-split="true"><th ${formalCellGeometry(240, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">任务/交付物</th><th ${formalCellGeometry(120, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">负责人</th><th ${formalCellGeometry(120, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">完成期限</th><th ${formalCellGeometry(144, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">验收标准</th></tr></thead><tbody><tr data-row-cant-split="true"><td ${formalCellGeometry(240)} style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td><td ${formalCellGeometry(120)} style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td><td ${formalCellGeometry(120)} style="border: 1px solid #A6A6A6; padding: 6pt">【YYYY-MM-DD】</td><td ${formalCellGeometry(144)} style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td></tr></tbody></table>`;
}
...
export function buildFormalTemplateContent(template, options = {}) {
  ...
  const metadata = `<table data-template-table="metadata" ${formalTableGeometry} ${formalTableBorders} style="width: 100%; table-layout: fixed; border-collapse: collapse; margin: 0 0 14pt"><thead><tr data-row-repeat-header="true" data-row-cant-split="true"><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">文档信息</th><th ${formalCellGeometry(216, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">内容</th><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">文档信息</th><th ${formalCellGeometry(216, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">内容</th></tr></thead><tbody><tr data-row-cant-split="true"><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">文档主题</th><td ${formalCellGeometry(216)} style="border: 1px solid #A6A6A6; padding: 6pt">${title}</td><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">版本</th><td ${formalCellGeometry(216)} style="border: 1px solid #A6A6A6; padding: 6pt">V1.0</td></tr><tr data-row-cant-split="true"><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">适用对象</th><td ${formalCellGeometry(216)} style="border: 1px solid #A6A6A6; padding: 6pt">${audience}</td><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">建议篇幅</th><td ${formalCellGeometry(216)} style="border: 1px solid #A6A6A6; padding: 6pt">${expectedPages}</td></tr><tr data-row-cant-split="true"><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">编制人/部门</th><td ${formalCellGeometry(216)} style="border: 1px solid #A6A6A6; padding: 6pt">【请填写】</td><th ${formalCellGeometry(96, { header: true })} style="border: 1px solid #A6A6A6; padding: 6pt; background: #F2F4F7">编制日期</th><td ${formalCellGeometry(216)} style="border: 1px solid #A6A6A6; padding: 6pt">【YYYY-MM-DD】</td></tr></tbody></table>`;
