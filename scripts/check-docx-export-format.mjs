...
const content = `
  ...
  <p>Revision export <span class="revision-insert" data-revision-type="insert" data-revision-id="10" data-revision-author="Revision User" data-revision-date="2026-07-16T05:00:00.000Z">inserted export text</span> <span class="revision-delete" data-revision-type="delete" data-revision-id="11" data-revision-author="Revision User" data-revision-date="2026-07-16T05:01:00.000Z">deleted export text</span></p>
...
assert.match(documentXml, /<w:ins(?=[^>]+w:id="10")(?=[^>]+w:author="Revision User")[^>]*>[\s\S]*<w:t[^>]*>inserted export text<\/w:t>[\s\S]*<\/w:ins>/);
assert.match(documentXml, /<w:del(?=[^>]+w:id="11")(?=[^>]+w:author="Revision User")[^>]*>[\s\S]*<w:delText[^>]*>deleted export text<\/w:delText>[\s\S]*<\/w:del>/);
